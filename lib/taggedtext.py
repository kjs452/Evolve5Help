...
class Node:
	...
	#	
	# Convert 'self' into an error node with 'msg'.
	# Uses the location of 'n' for error.
	# The children of n are preserved.
	# (Error nodes can have children)
	#
