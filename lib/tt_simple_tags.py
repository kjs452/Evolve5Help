...
def run(root):
	...
	eval_functions = {
		...
		'HRULE':	( lambda root: translate(root, '<HR>\n', '') ),
		'Caption':	( lambda root: translate(root, '<CENTER><I>', '</I></CENTER><BR>') ),
		'BREAK':	( lambda root: translate(root, '', '<BR><BR>') ),

		'SC':		( lambda root: translate(root, 
									'<font style="font-variant: small-caps">',
									'</font>' ) ),

		'Title':			( lambda root: translate_toc(root, 0, "<h1>", "</h1>") ),
